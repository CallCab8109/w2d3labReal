...
// CODE HERE
const totPrice = orders.map(function(cost) {
  return cost.price = (cost.price * cost.tax)
})
...
//due to some circumstances beyond my control i couldn't work on this til very late and tried to learn from the solutions guie. i understand it but have made a note to come back again and try to solve these later