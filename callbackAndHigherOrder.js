...
const uniq = (array, cb) => {
  let unique = array.filter(function(item, pos) {
...
// uniq([1,2,2,4,5], function(result){
//   console.log(result);
//   })
...
const each = (arr, cb) => {
  arr.forEach((item, index)=> cb(item,i))
}
...
//had to look at solutions but it makes complete sense
// UNCOMMENT THE FUNCTION CALL BELOW
// RUN THIS FILE WITH NODE
// CHECK YOUR ANSWER
